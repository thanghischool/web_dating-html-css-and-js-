...
fetch(personalApi)
  ...
  .then(function (imgs) {
    ...
    var img_background = imgs.map(function (img_2) {
      return `
      <img class="img-1" src="${img_2.img_background}" alt="" style="width: 1200px; height: 479px; border-radius: 20px">
      <img class="img-2" src="${img_2.img_avatar}" alt="" style="width: 190px; height: 190px; border-radius: 50%">
      `;
    });
